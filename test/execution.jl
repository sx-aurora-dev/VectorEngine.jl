...
@testset "varargs" begin
    # FAIL on VE, output is not captured correctly
...
#B#@testset "object invoke" begin
#B#    # this mimics what is generated by closure conversion
#B#    # FAIL on VE, kills VEO context
#B#
#B#    @eval struct KernelObject{T} <: Function
#B#        val::T
#B#    end
#B#
#B#    function (self::KernelObject)(a)
#B#        a[] = self.val
#B#        return
#B#    end
#B#
#B#    function outer(a, val)
#B#       inner = KernelObject(val)
#B#       @veda inner(a)
#B#    end
#B#
#B#    a = [1.]
...
#B#    outer(a_dev, 2.)
#B#
#B#    @test Array(a_dev) ≈ [2.]
#B#end
#B#
#B#@testset "closures" begin
#B#    # FAIL on VE, kills VEO context
#B#    function outer(a_dev, val)
#B#       function inner(a)
#B#            # captures `val`
#B#            a[] = val
#B#            return
